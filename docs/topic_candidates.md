...
- Generated at: 2026-02-20 02:55:15
...
## 1. 시작하는 개발자들은 첫 직장 첫 연봉에 너무 연연하지 않아야 된다는 말에 백 번 동감하나, 오늘 현 직장에 전 직장 후배를 추천하...

- Topic: `실행력/의사결정`
- Aggregate score: `111.04`
- Tweet count: `3`
- Primary Tweet ID: `1579845580381368320`
- Date: `2022-10-11`
- Engagement(sum): `981`
- Book signal(sum): `1`
...
## 2. 개발자의 사회성부족은 매니저역할을 할때 더 처참하게 드러난다.

- Topic: `독서/책 인용 인사이트`
- Aggregate score: `108.98`
- Tweet count: `1`
- Primary Tweet ID: `1584320641511337985`
- Date: `2022-10-23`
- Engagement(sum): `1037`
- Book signal(sum): `1`
...
## 3. 특정 도메인의 스타트업에서 초기멤버로서 정말 열심히 했던 적이 있었다.

- Topic: `커리어/이직 인사이트`
- Aggregate score: `88.42`
- Tweet count: `4`
- Primary Tweet ID: `1566579498866188288`
- Selected Tweet ID: `1566579496706138113`
- Date: `2022-09-05`
- Engagement(sum): `757`
- Book signal(sum): `0`
...
## 4. 이 분기 하나를 없애는 것에 합의한 기획자와 개발자에게 경의를 표한다. 단순하게 만드는 것이 훨씬 어렵다.

- Topic: `실행력/의사결정`
- Aggregate score: `56.59`
- Tweet count: `1`
- Primary Tweet ID: `1954345756921663521`
- Date: `2025-08-10`
- Engagement(sum): `560`
- Book signal(sum): `0`
...
## 5. 역설적이지만 퇴사준비로 가장 추천하는 것은 새로운 스택 익히는게 아니라, 다니던 회사의 코드나 인프라의 이해도를 높히는 것인 것...

- Topic: `실행력/의사결정`
- Aggregate score: `51.1`
- Tweet count: `1`
- Primary Tweet ID: `1694618153719075304`
- Date: `2023-08-24`
- Engagement(sum): `495`
- Book signal(sum): `0`
...
## 6. 우리회사 개발자분도 디자인시스템을 만든 것에 대한 후회를 좀 하더라. 디자인시스템이라고 컴포넌트로 만들어둔게 사실상 다른 UI프레...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `48.82`
- Tweet count: `1`
- Primary Tweet ID: `1957040031052521665`
- Date: `2025-08-17`
- Engagement(sum): `473`
- Book signal(sum): `0`
...
## 7. 스타트업썰, 대표님이 날 첫 개발자로 채용하시면서 백엔드는 외주를 줘서 거의 다 완성이 되어있으니 프론트엔드만 해달라고 했다. 입...

- Topic: `코드 품질/리뷰`
- Aggregate score: `43.25`
- Tweet count: `4`
- Primary Tweet ID: `1682762420257972224`
- Date: `2023-07-22`
- Engagement(sum): `306`
- Book signal(sum): `0`
...
## 8. 팀장 일주일 했다. 모든 레포 합치기, 마이크로서비스 비슷하게 나눠논거 합치기, 메세지브로커 없애기 시작했다. 다행히도 기존 분들...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `39.62`
- Tweet count: `3`
- Primary Tweet ID: `1953948443598057939`
- Date: `2025-08-08`
- Engagement(sum): `302`
- Book signal(sum): `0`
...
## 9. 열심히 매력적인 채용공고를 작성해서 한 달만에 개발자 네 명을 채용한 적이 있었다.

- Topic: `커리어/이직 인사이트`
- Aggregate score: `27.84`
- Tweet count: `2`
- Primary Tweet ID: `1525453786567049217`
- Date: `2022-05-14`
- Engagement(sum): `233`
- Book signal(sum): `0`
...
## 10. 언어가 추가될테니 i18n부터 셋팅하자 -&gt; 추가안됨 디비를 바꿀 수 있으니 특정 디비 종속적인 쿼리 쓰지말자 -&gt; 안...

- Topic: `실행력/의사결정`
- Aggregate score: `27.67`
- Tweet count: `1`
- Primary Tweet ID: `1952147386714988904`
- Date: `2025-08-03`
- Engagement(sum): `262`
- Book signal(sum): `0`
...
## 11. 크롤링은 엣지 케이스를 내가 처리하느냐 내가 돈을 준 업체가 처리하느냐 정도의 차이일뿐 누군가 그걸 해야하더라. 금융정보 직접 크...

- Topic: `실행력/의사결정`
- Aggregate score: `27.59`
- Tweet count: `2`
- Primary Tweet ID: `1886055516151148709`
- Date: `2025-02-02`
- Engagement(sum): `221`
- Book signal(sum): `0`
...
## 12. 개발자의 이력서 잘쓰는 법이 공유되는 것을 보서 새삼 우리 채용에 자부심을 느낀다.

- Topic: `커리어/이직 인사이트`
- Aggregate score: `22.59`
- Tweet count: `1`
- Primary Tweet ID: `1575636565975769088`
- Date: `2022-09-30`
- Engagement(sum): `210`
- Book signal(sum): `0`
...
## 13. 특히 팀 구성인원의 변동이 크지 않을 시절에는 이게 진짜 좋았다. django를 정말 잘하시는 몇 분이 계셔주신게(특히 이분 ㅎㅎ...

- Topic: `백엔드/아키텍처`
- Aggregate score: `19.37`
- Tweet count: `4`
- Primary Tweet ID: `1849398004228464887`
- Date: `2024-10-24`
- Engagement(sum): `63`
- Book signal(sum): `0`
...
## 14. 주니어들을 데리고 코드품질 논하는 시간을 주2시간쯤 잡아보고 있다. 3년 전만 해도 아쉬운 리팩토링PR도 매몰비용과 감정적인 이유...

- Topic: `코드 품질/리뷰`
- Aggregate score: `18.91`
- Tweet count: `1`
- Primary Tweet ID: `1999700179994443976`
- Date: `2025-12-13`
- Engagement(sum): `172`
- Book signal(sum): `0`
...
## 15. 6년전 영록님과 면접을 봤는데, 일주일간 40여개의 메일을 주고 받으며 단계별로 과제를 진행했다. 떨어뜨리기 위한 과제가 아니라...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `17.82`
- Tweet count: `2`
- Primary Tweet ID: `1770388178052186591`
- Date: `2024-03-20`
- Engagement(sum): `127`
- Book signal(sum): `0`
...
## 16. 정말정말 고치고 싶은 끔찍한 습관이 있는데, 이슈가 생겼을때 “내가 이럴꺼라고 했잖아요”라고 하는 것이다. 말을 하는 사람과 듣는...

- Topic: `디버깅/장애 대응`
- Aggregate score: `17.79`
- Tweet count: `1`
- Primary Tweet ID: `1730776589703782511`
- Date: `2023-12-02`
- Engagement(sum): `162`
- Book signal(sum): `0`
...
## 17. 잡부개발자는 MVP때까지만 쓰고 성공하면 물갈이 될 수 있다는 데에 공감하지만 90%이상의 기업이 성공하지 못하고 MVP만 만들고...

- Topic: `실행력/의사결정`
- Aggregate score: `17.07`
- Tweet count: `1`
- Primary Tweet ID: `1640653629949632515`
- Date: `2023-03-28`
- Engagement(sum): `155`
- Book signal(sum): `0`
...
## 18. 4년만에 다시 팀장이 되었다. 그간 안해볼려고 몸비틀며 살아왔는데 이번은 이직에 조바심을 너무 냈던 것 같다. 기왕 된거 예전에...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `16.18`
- Tweet count: `1`
- Primary Tweet ID: `1951233401018786260`
- Date: `2025-08-01`
- Engagement(sum): `146`
- Book signal(sum): `0`
...
## 19. 예전에는 시스템이 아닌 몇몇 능력자에 의존하는 조직은 체계가 없고 지속불가능한 안좋은 구성이라고 생각했다. 하지만 이번 OpenA...

- Topic: `실행력/의사결정`
- Aggregate score: `16.17`
- Tweet count: `2`
- Primary Tweet ID: `1726749015105253411`
- Date: `2023-11-20`
- Engagement(sum): `106`
- Book signal(sum): `0`
...
## 20. 내가 경험한 SI의 한계는 시간의 흐름에 따른 코드의 생명주기를 경험할 수 없다는 것이었다. 영영 채점하지 않는 시험을 계속 치는...

- Topic: `코드 품질/리뷰`
- Aggregate score: `16.03`
- Tweet count: `1`
- Primary Tweet ID: `1634884225869680644`
- Date: `2023-03-12`
- Engagement(sum): `144`
- Book signal(sum): `0`
...
## 21. 예전에 게임쪽에 있던 분과 일할 기회가 있었는데 같이 디비설계를 하면서 게임쪽은 FK를 잘 안건다는 이야기를 들었다. 그땐 이해하...

- Topic: `코드 품질/리뷰`
- Aggregate score: `14.72`
- Tweet count: `3`
- Primary Tweet ID: `1885509188572643418`
- Date: `2025-02-01`
- Engagement(sum): `24`
- Book signal(sum): `1`
...
## 22. QA팀에서 TC 3천개 받아와서 클로드코드 스킬로 케이스 그룹 선별/분석, playwright로 통과하는 테스트코드 작성, PR작...

- Topic: `코드 품질/리뷰`
- Aggregate score: `14.72`
- Tweet count: `1`
- Primary Tweet ID: `1991071852182004147`
- Date: `2025-11-19`
- Engagement(sum): `132`
- Book signal(sum): `0`
...
## 23. 우리팀이 밑바닥부터 만든 서비스가 오픈하여 기존 사이트를 대체했다. 하루 사용자 n만명을 버텼다. 오픈하고도 맘편히 고쳐가며 하루...

- Topic: `코드 품질/리뷰`
- Aggregate score: `14.5`
- Tweet count: `1`
- Primary Tweet ID: `1635652245021933568`
- Date: `2023-03-14`
- Engagement(sum): `130`
- Book signal(sum): `0`
...
## 24. 소프트웨어 자체가 제품인 회사의 개발자와 전통적인 산업을 하는 회사에 개발자는 갭이 꽤 있구나. 전자인 회사만 다니다가 여기가 후...

- Topic: `실행력/의사결정`
- Aggregate score: `14.27`
- Tweet count: `2`
- Primary Tweet ID: `1923340232969044038`
- Date: `2025-05-16`
- Engagement(sum): `87`
- Book signal(sum): `0`
...
## 25. 솔루션으로 쇼핑몰을 운영중인데 자체개발로 바꾸고 싶어요. 페이지도 몇 개 안되고 그대로 옮겨 개발하니 어렵지 않겠죠? (+ 60페...

- Topic: `팀 생산성/협업 방식`
- Aggregate score: `14.07`
- Tweet count: `1`
- Primary Tweet ID: `1619080963539222528`
- Date: `2023-01-27`
- Engagement(sum): `124`
- Book signal(sum): `0`
...
## 26. 빡시게 RDB 스키마 정규화해가며 관리하던 회사에서 mongodb에다가 마이그레이션 없이 스키마 바꿔가며 집어넣는 회사에 오니 눈...

- Topic: `백엔드/아키텍처`
- Aggregate score: `14.03`
- Tweet count: `2`
- Primary Tweet ID: `1950859517786468533`
- Date: `2025-07-31`
- Engagement(sum): `85`
- Book signal(sum): `0`
...
## 27. “지원자에게 집에서 할 수 있는 기술 문제로 실력을 테스트하는 경우, 지원자가 AI를 사용해 문제를 해결할 수 있다는 것을 받아들...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `13.82`
- Tweet count: `1`
- Primary Tweet ID: `1928418979875271054`
- Date: `2025-05-30`
- Engagement(sum): `126`
- Book signal(sum): `0`
...
## 28. 프리도 아니고 자기회사 개발자에게 좀 설득없이 시키는대로 했으면 좋겠다고 하는 경영진은, 시키는대로 해서 몇 배 이상의 예산을 쓰...

- Topic: `독서/책 인용 인사이트`
- Aggregate score: `13.77`
- Tweet count: `1`
- Primary Tweet ID: `1775677839611961615`
- Date: `2024-04-04`
- Engagement(sum): `86`
- Book signal(sum): `1`
...
## 29. 특히 ES는 스무번 정도 고민하고 쓰면 좋겠다. 노드, 인덱스, 데이터 동기화 등 신경쓸 지점이 확 는다. 굳이 필요하다면 RDB...

- Topic: `실행력/의사결정`
- Aggregate score: `13.67`
- Tweet count: `1`
- Primary Tweet ID: `1960550223006294362`
- Date: `2025-08-27`
- Engagement(sum): `120`
- Book signal(sum): `0`
...
## 30. 오퍼 메일을 받자마자 바로 회사에 퇴사하겠다고 말했다. 3년의 이커머스 여정이 이렇게 끝나는구나. 커리어를 이어갈 수 있으면 좋겠...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `13.57`
- Tweet count: `1`
- Primary Tweet ID: `1930579926589313261`
- Date: `2025-06-05`
- Engagement(sum): `120`
- Book signal(sum): `0`
...
## 31. 더 괴로운 기억은 3개월짜리 MVP하고나면 그담에 다시 제대로 프로덕션 개발 할 계획이라고 해서 호다닥 아슬아슬한 카드로 만든 집...

- Topic: `실행력/의사결정`
- Aggregate score: `13.04`
- Tweet count: `1`
- Primary Tweet ID: `1607811746391273473`
- Date: `2022-12-27`
- Engagement(sum): `116`
- Book signal(sum): `0`
...
## 32. 이전회사에서 만지던게 three.js로 돌아가는 솔루션이었다. 인상깊었던건 vuejs위에서 돌아가게 해놨는데, 몇백메가하던 thr...

- Topic: `실행력/의사결정`
- Aggregate score: `12.27`
- Tweet count: `2`
- Primary Tweet ID: `1639596259123302401`
- Date: `2023-03-25`
- Engagement(sum): `74`
- Book signal(sum): `0`
...
## 33. 어제 팀에 새로 합류한 분과 페어프롬프팅(?)응 했다.

- Topic: `코드 품질/리뷰`
- Aggregate score: `11.53`
- Tweet count: `3`
- Primary Tweet ID: `2018682764342530338`
- Selected Tweet ID: `2018682761184227785`
- Date: `2026-02-03`
- Engagement(sum): `24`
- Book signal(sum): `0`
- URL: https://x.com/i/web/status/2018682764342530338
- Reason: 에이전트 페어 프롬프팅을 실무 온보딩과 병렬 작업 방식으로 연결한 최신 팀 운영 사례다.
- Excerpt: 클로드가 작업현황을 어떻게 파악하고 있는지 물어보니 주섬주섬 몇일전에 만들고 갱신하지 않은 md파일을 찾아오셨다. 현재까지 진척된 사항을 분석해서 남은 작업을 구체하도록 md를 갱신시키고 코드작성 리뷰 리팩토링 문서...

## 34. django의 prefetch_related는 디비부하를 줄일 수 있는 좋은 방법 중 하나지만 prefetch 해 온 결과물을 조...

- Topic: `백엔드/아키텍처`
- Aggregate score: `11.23`
- Tweet count: `3`
- Primary Tweet ID: `1863775406018461985`
- Date: `2024-12-03`
- Engagement(sum): `15`
- Book signal(sum): `0`
...
## 35. MSA쓰는 조직에서는 경력 개발자 채용에 MSA 경험에 대한 가점이 너무 커서 MSA경험이 없다면 가급적 현재 조직에서 도입해보고...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `10.85`
- Tweet count: `3`
- Primary Tweet ID: `1828762281012036034`
- Date: `2024-08-28`
- Engagement(sum): `17`
- Book signal(sum): `0`
...
## 36. 배포되지 않은 코드는 여러가지 측면에서 해롭다. 개발자는 배포되지 않은 코드에 대한 컨텍스트를 계속 들고 있어야 해서 두뇌를 쓸데...

- Topic: `실행력/의사결정`
- Aggregate score: `10.74`
- Tweet count: `2`
- Primary Tweet ID: `2021348471765446942`
- Date: `2026-02-10`
- Engagement(sum): `56`
- Book signal(sum): `0`
...
## 37. 여러분 aws cloudtail로그의 기본 보존기간은 90일입니다. 꼭 s3에 보존하도록 설정하세요. 안그러면 90일 전에 누가...

- Topic: `실행력/의사결정`
- Aggregate score: `10.62`
- Tweet count: `1`
- Primary Tweet ID: `1962290184554483786`
- Date: `2025-08-31`
- Engagement(sum): `93`
- Book signal(sum): `0`
...
## 38. 오늘 첨으로 데브옵스 분이 내가 만든 서비스 인프라 문제를 해결해주시는걸 경험해봤다. aws ecs로 올려뒀던게 vpc쪽 변경사항...

- Topic: `디버깅/장애 대응`
- Aggregate score: `9.71`
- Tweet count: `2`
- Primary Tweet ID: `1842066089574072429`
- Date: `2024-10-04`
- Engagement(sum): `12`
- Book signal(sum): `1`
...
## 39. 한 피쳐를 1명이 1개월간 개발하는 것과 2명이 2주간 개발하는 것은 절대적인 리소스양이 비슷해 보여도 효율은 후자가 압도적으로...

- Topic: `코드 품질/리뷰`
- Aggregate score: `9.53`
- Tweet count: `1`
- Primary Tweet ID: `1951251873035624637`
- Date: `2025-08-01`
- Engagement(sum): `80`
- Book signal(sum): `0`
...
## 40. 그래서 가급적 이직 타이밍은 내가 회사에 충분히 기여한 것이 인정되는 때로 잡는다.

- Topic: `독서/책 인용 인사이트`
- Aggregate score: `9.43`
- Tweet count: `2`
- Primary Tweet ID: `1712116266838659483`
- Selected Tweet ID: `1712473248255090967`
- Date: `2023-10-11`
- Engagement(sum): `3`
- Book signal(sum): `1`
- URL: https://x.com/i/web/status/1712116266838659483
- Reason: 퇴사 시점의 윤리와 평판 관리라는 커리어 의사결정 맥락이 분명하다.
- Excerpt: 어릴적 교회다닐때 따르던 전도사가 있었는데 학생하나가 사고를 쳐서 책임진다며 교회를 떠났고 나는 그분이 없어진 교회에 흥미를 잃었다. 난 아직도 그분이 진게 책임은 맞았을까, 문제가 있음 고치고 버텨내야지 떠나는게...

## 41. postgres 최적화 하나 경험, 인덱스를 쓰더라도 인덱스의 크기가 크게 되면 일단 스캔하는데 오래걸린다. 필터해서 쓰는 주요...

- Topic: `백엔드/아키텍처`
- Aggregate score: `8.85`
- Tweet count: `2`
- Primary Tweet ID: `1742180181228634440`
- Date: `2024-01-02`
- Engagement(sum): `38`
- Book signal(sum): `0`
...
## 42. 얼마전에 본 구글어쩌고 책에서도 매니저는 how가 아니라 what을 고민하라는데.. 현실은 대개 코드에 가장 많은 기여를 하는 혹...

- Topic: `독서/책 인용 인사이트`
- Aggregate score: `8.71`
- Tweet count: `1`
- Primary Tweet ID: `1647217911990452225`
- Date: `2023-04-15`
- Engagement(sum): `36`
- Book signal(sum): `1`
...
## 43. 좀 다른 이야기지만 보통 캐시가 필요해질 때 쯤 들어온 다음 개발자는 너무 쉽게 캐시가 없는게 문제네요 라고 말한다. 이제 캐시가...

- Topic: `실행력/의사결정`
- Aggregate score: `8.71`
- Tweet count: `1`
- Primary Tweet ID: `1827994829974057148`
- Date: `2024-08-26`
- Engagement(sum): `76`
- Book signal(sum): `0`
...
## 44. 기획을 안줘서 개발이 어렵다는 팀원분께 일단 기획이고 나발이고 개발안되면 개발자만 욕먹으니까 일단 목업으로라도 구현하고 붙여서 기...

- Topic: `실행력/의사결정`
- Aggregate score: `8.28`
- Tweet count: `1`
- Primary Tweet ID: `1953036293291774015`
- Date: `2025-08-06`
- Engagement(sum): `67`
- Book signal(sum): `0`
...
## 45. 분명 스테이징 서버에서는 잘 돌던것이 프로덕션에 가서 일부 고객에게만 오류가 발생했다.

- Topic: `백엔드/아키텍처`
- Aggregate score: `8.11`
- Tweet count: `1`
- Primary Tweet ID: `1664359602962698246`
- Date: `2023-06-01`
- Engagement(sum): `66`
- Book signal(sum): `0`
...
## 46. 안그래도 오늘 프론트분이랑 이야기하다가 모노레포 커지면서 타입추론 부담될거 같다고 하시길래, 이거 레포합쳐서 절약되는 개발리소스가...

- Topic: `실행력/의사결정`
- Aggregate score: `8.01`
- Tweet count: `1`
- Primary Tweet ID: `1955258737037369790`
- Date: `2025-08-12`
- Engagement(sum): `66`
- Book signal(sum): `0`
...
## 47. 외래키를 안쓰는 형태의 디비 사용법에 대해 이해하기 어려웠는데, 오늘 외래키 필드 하나 추가하다가 제약 만들면서 테이블에 몇 분이...

- Topic: `실행력/의사결정`
- Aggregate score: `7.89`
- Tweet count: `1`
- Primary Tweet ID: `1732405141863817423`
- Date: `2023-12-06`
- Engagement(sum): `68`
- Book signal(sum): `0`
...
## 48. 아 좋았다. 스프링 게이트웨이에서 url 이중 인코딩 문제로 한참을 헤메던 팀원분에게 3개월 전에 머지된 동일문제 PR 찾아드렸다...

- Topic: `코드 품질/리뷰`
- Aggregate score: `7.38`
- Tweet count: `2`
- Primary Tweet ID: `1957405982750859435`
- Date: `2025-08-18`
- Engagement(sum): `23`
- Book signal(sum): `0`
...
## 49. 작년 5월에 쓴 업무메모 1.서비스에 사용자행동 추적이 정확하게 되는지 2. 어트리뷰션이 정확히 측정되는지 3. 광고플랫폼 연계추...

- Topic: `코드 품질/리뷰`
- Aggregate score: `6.77`
- Tweet count: `2`
- Primary Tweet ID: `1768464634284282194`
- Date: `2024-03-15`
- Engagement(sum): `22`
- Book signal(sum): `0`
...
## 50. htmx로 만들어진 서비스에 오랜만에 기능추가 요청이 왔다. 예전과 다르게 백엔드 프론트엔드 조직이 나뉘어져 있다보니 어느쪽 조직...

- Topic: `실행력/의사결정`
- Aggregate score: `6.32`
- Tweet count: `2`
- Primary Tweet ID: `1834189666397872554`
- Date: `2024-09-12`
- Engagement(sum): `18`
- Book signal(sum): `0`
...
## 51. 기획서 없이 개발했던 때에는 크게 필요성을 못느꼈던 QA가 기획서대로 작업해야 할 때는 큰 도움이 되는걸 느낌 사실 기획서 의도를...

- Topic: `독서/책 인용 인사이트`
- Aggregate score: `6.3`
- Tweet count: `1`
- Primary Tweet ID: `1844552426738844027`
- Date: `2024-10-11`
- Engagement(sum): `10`
- Book signal(sum): `1`
...
## 52. AWS는 늘 많은 스타트업들에게 지원 프로그램이라는 명목으로 많은 크레딧을 지급하고 교육을 해주며 대용량 트래픽 문제를 과장하고...

- Topic: `디버깅/장애 대응`
- Aggregate score: `6.3`
- Tweet count: `1`
- Primary Tweet ID: `1562641456594296833`
- Date: `2022-08-25`
- Engagement(sum): `49`
- Book signal(sum): `0`
...
## 53. 비슷하게 회사에서 쓰는데 하나의 백엔드코드로 사용자용 서버에도 배포하고 백오피스용 서버도 배포하고 배치잡도 돌린다. 이걸 뭉쳐 배...

- Topic: `백엔드/아키텍처`
- Aggregate score: `6.23`
- Tweet count: `2`
- Primary Tweet ID: `1735280446970401111`
- Date: `2023-12-14`
- Engagement(sum): `14`
- Book signal(sum): `0`
...
## 54. 요구사항이 막 바뀌는 상황으로 곤란해하고 있어요. -&gt; 새로운 요구사항이 발견되는 상황은 비즈니스 적으로 좋은 상황일 수 있...

- Topic: `실행력/의사결정`
- Aggregate score: `6.14`
- Tweet count: `1`
- Primary Tweet ID: `1939648321532141640`
- Date: `2025-06-30`
- Engagement(sum): `46`
- Book signal(sum): `0`
...
## 55. wkwebview는 캐시에 대해 별도로 정책을 설정해줄 수 있다. 그리고 무조건 캐시있으면 절대 서버에 요청하지 않는다 같은 괴이...

- Topic: `프론트엔드/웹 개발`
- Aggregate score: `6.07`
- Tweet count: `1`
- Primary Tweet ID: `1852256940258177424`
- Date: `2024-11-01`
- Engagement(sum): `10`
- Book signal(sum): `1`
...
## 56. PR메세지에 제미나이로 부터 받은 리뷰를 추가하기 시작했다. 코드레빗 같은 서비스도 괜찮지만 커서는 정액제라 사실상 무료니까 좋다...

- Topic: `코드 품질/리뷰`
- Aggregate score: `6.0`
- Tweet count: `2`
- Primary Tweet ID: `1914997618926928012`
- Date: `2025-04-23`
- Engagement(sum): `8`
- Book signal(sum): `0`
...
## 57. 예전에 우리팀은 출근 첫날 커밋하기가 미션이었다. 나도 첫출근날부터 이슈를 받아 겨우겨우 커밋을 했다. 괜찮은 경험이었다. 숲을...

- Topic: `실행력/의사결정`
- Aggregate score: `5.32`
- Tweet count: `1`
- Primary Tweet ID: `1834142380716687478`
- Date: `2024-09-12`
- Engagement(sum): `41`
- Book signal(sum): `0`
...
## 58. 어제 팀애 주니어분이 금요일 오후 여섯시에 프로덕션 배포하고 바로 집에 가는걸 보고 내심 공포감에 휩싸였🥶 안정적인 배포 시스템이...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `5.02`
- Tweet count: `1`
- Primary Tweet ID: `1646998484623699971`
- Date: `2023-04-14`
- Engagement(sum): `38`
- Book signal(sum): `0`
...
## 59. 앱을 개발하고 싶다는 분과 잠깐 상담을 해드렸다. 여러 앱에서 느낀 불편함 개선, 비지니스 효율 개선, 업무 노하우의 보안 등을...

- Topic: `실행력/의사결정`
- Aggregate score: `4.98`
- Tweet count: `1`
- Primary Tweet ID: `1784746869756919838`
- Date: `2024-04-29`
- Engagement(sum): `38`
- Book signal(sum): `0`
...
## 60. 동료분께 컨텍스트문서를 이용한 바이브코딩 설명하다가 느낀것 아무 맥락없이 일부 구현을(심지어 본인이 잘 안되서)툭하니 요청하는건...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `4.97`
- Tweet count: `1`
- Primary Tweet ID: `1948543598657765879`
- Date: `2025-07-25`
- Engagement(sum): `35`
- Book signal(sum): `0`
...
## 61. 그러나 안타깝게도 지금 회사에서는 11개 언어로 서비스를 만들고 클라우드 밴더 종속성을 줄이는 작업을 하고 있습니다. 요지는 미래...

- Topic: `실행력/의사결정`
- Aggregate score: `4.6`
- Tweet count: `1`
- Primary Tweet ID: `1952329332791361568`
- Date: `2025-08-04`
- Engagement(sum): `30`
- Book signal(sum): `0`
...
## 62. 나도 지금 회사에서 한 개발환경 셋팅은 고역이었다. react앱 하나 serve하는데 hosts를 셋팅하고 dev인프라와 연결해준...

- Topic: `프론트엔드/웹 개발`
- Aggregate score: `4.2`
- Tweet count: `1`
- Primary Tweet ID: `1981988509780255107`
- Date: `2025-10-25`
- Engagement(sum): `25`
- Book signal(sum): `0`
...
## 63. 하루면 될꺼 같은데.. 라는 늪에서 10년째 벗어나질 못하고 있다. 수백번 이렇게 뒤집어 쓰고 생명력 소모를 했다. 회사에서 사업...

- Topic: `실행력/의사결정`
- Aggregate score: `4.14`
- Tweet count: `1`
- Primary Tweet ID: `1745045207111102841`
- Date: `2024-01-10`
- Engagement(sum): `27`
- Book signal(sum): `0`
...
## 64. 오늘 팀원분들 대상으로 클로드코드 핸즈온세션을 두번 했다. 실무 이슈 하나 잡아서 작업계획을 관리하면서 작은 단위로 진행하게 했다...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `4.05`
- Tweet count: `1`
- Primary Tweet ID: `1955235186297495864`
- Date: `2025-08-12`
- Engagement(sum): `25`
- Book signal(sum): `0`
...
## 65. 리팩토링에 코드스멜 같은 것보다 더 중요함에도 잘 눈에 띄지 않는 원칙이 있는데 “작게 리팩토링 하기”다. 자칫 욕심에 딸려 들어...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `4.02`
- Tweet count: `1`
- Primary Tweet ID: `1999748966624452968`
- Date: `2025-12-13`
- Engagement(sum): `24`
- Book signal(sum): `0`
...
## 66. 너 나 우리의 디비😭 비슷한 예로 초기에 한 pg사의 결제수단에 따라 나눈 컬럼이 나중에 pg사가 추가되면서 꼬여갔으나 결제 너무...

- Topic: `실행력/의사결정`
- Aggregate score: `3.93`
- Tweet count: `1`
- Primary Tweet ID: `1718762974578708620`
- Date: `2023-10-29`
- Engagement(sum): `26`
- Book signal(sum): `0`
...
## 67. 오늘도 페어를 했다. 사용중인 매니지드 메세지브로커서비스의 카프카 대체 작업을 아무런 검증코드 없이 뛰어드는 것을 붙잡고 api두...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `3.79`
- Tweet count: `1`
- Primary Tweet ID: `1952685872257860011`
- Date: `2025-08-05`
- Engagement(sum): `24`
- Book signal(sum): `0`
...
## 68. 팀에 하루의 1/3 이상은 페어로 개발하는 분들이 있는데, 결국 그 쪽 분들이 개발 성과도 좋고 개발 숙련도도 오르는게 보인다....

- Topic: `코드 품질/리뷰`
- Aggregate score: `3.78`
- Tweet count: `1`
- Primary Tweet ID: `1752332607663329408`
- Date: `2024-01-30`
- Engagement(sum): `27`
- Book signal(sum): `0`
...
## 69. 논의끝에 디자인시스템만을 위해 존재하던 래퍼컴포넌트들을 제거하고 베이스가 되는 ui프레임워크의 theme과 css variable...

- Topic: `프론트엔드/웹 개발`
- Aggregate score: `3.51`
- Tweet count: `1`
- Primary Tweet ID: `1995457868590379131`
- Date: `2025-12-01`
- Engagement(sum): `20`
- Book signal(sum): `0`
...
## 70. 커머스들이 오픈마켓 보다 자체 플랫폼 구축하는게 생각보다 정산주기로 인한 재무적 이점이 크다는 걸 알았다. 티몬으로 인해 더 부각...

- Topic: `실행력/의사결정`
- Aggregate score: `3.39`
- Tweet count: `1`
- Primary Tweet ID: `1829348471813668917`
- Date: `2024-08-30`
- Engagement(sum): `18`
- Book signal(sum): `0`
...
## 71. IaC 뭘루하냐 고민중이다. 나는 예전에 python스크립트로 다 했었을때 경험이 좋았고 다만 지금 회사는 주로 typescrip...

- Topic: `백엔드/아키텍처`
- Aggregate score: `3.38`
- Tweet count: `1`
- Primary Tweet ID: `1981319361093865762`
- Date: `2025-10-23`
- Engagement(sum): `18`
- Book signal(sum): `0`
...
## 72. LLM의 시대, 코드리뷰 애로사항은 우리팀에서는 페어프로그래밍으로 꽤 많이 해소가 되고 있다. 둘이서 같이 어떤식으로 프롬프트를...

- Topic: `코드 품질/리뷰`
- Aggregate score: `3.32`
- Tweet count: `1`
- Primary Tweet ID: `1959547348868079882`
- Date: `2025-08-24`
- Engagement(sum): `18`
- Book signal(sum): `0`
...
## 73. 몇년전 제품에 MSA도입 오판으로 10MM쯤 개발리소스를 허비한적이 있었다.

- Topic: `실행력/의사결정`
- Aggregate score: `3.31`
- Tweet count: `1`
- Primary Tweet ID: `1667478906444853248`
- Date: `2023-06-10`
- Engagement(sum): `17`
- Book signal(sum): `0`
...
## 74. 내가 CTO면 어떤 언어를 쓸까? 그 당시 팀원들의 숙련/선호도가 높은 언어를 고를 수 밖에 없을 것 같다. 결국 그들이 만들고...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `3.28`
- Tweet count: `1`
- Primary Tweet ID: `1766311193751466172`
- Date: `2024-03-09`
- Engagement(sum): `19`
- Book signal(sum): `0`
...
## 75. 지난 2년간 회사 서비스 main브랜치의 python코드의 라인수를 시각화 해봤다. 커미터는 보통 12~15명 선을 유지했던거 같...

- Topic: `백엔드/아키텍처`
- Aggregate score: `3.12`
- Tweet count: `1`
- Primary Tweet ID: `1849474510527095124`
- Date: `2024-10-24`
- Engagement(sum): `17`
- Book signal(sum): `0`
...
## 76. 개발자의 퇴사는 GPU리소스에 한 1억쯤 부어서 자사 프로덕트의 문제해결에 스페셜라이즈드하게 훈련된 고성능 모델을 깔끔하게 지우는...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `2.91`
- Tweet count: `1`
- Primary Tweet ID: `1757423558085714238`
- Date: `2024-02-13`
- Engagement(sum): `14`
- Book signal(sum): `0`
...
## 77. 개발은 사용자에게 가치를 제공한다는 목표가 있고 이를 효율적으로 달성하기 위한 다양한 수단이 있는듯 하다. 테스트 주도 개발, 산...

- Topic: `코드 품질/리뷰`
- Aggregate score: `2.78`
- Tweet count: `1`
- Primary Tweet ID: `1607107505435598849`
- Date: `2022-12-25`
- Engagement(sum): `12`
- Book signal(sum): `0`
...
## 78. 팀에서 물어보는 법도 크게 다르지 않다. A로 할까요 B로 할까요? (호응없음)

- Topic: `실행력/의사결정`
- Aggregate score: `2.62`
- Tweet count: `1`
- Primary Tweet ID: `1749466474123821173`
- Date: `2024-01-22`
- Engagement(sum): `11`
- Book signal(sum): `0`
...
## 79. 운영8 개발2인 조직은 살짝만 퍼포먼스가 떨어져도 아무것도 못하고 꼼짝없이 멈춘다. 운영8만 겨우 하다가 뭐라도 나아가야지 하고...

- Topic: `실행력/의사결정`
- Aggregate score: `2.62`
- Tweet count: `1`
- Primary Tweet ID: `1783785496663241098`
- Date: `2024-04-26`
- Engagement(sum): `10`
- Book signal(sum): `0`
...
## 80. 트랜잭션이랑 celery랑 잘못 엮이기 시작하니 여기저기서 터지는구나. 초기에 팀에서 가급적 트랜잭션 잘 안쓰길래 왜그러지 싶었는...

- Topic: `코드 품질/리뷰`
- Aggregate score: `2.6`
- Tweet count: `1`
- Primary Tweet ID: `1843233019416785242`
- Date: `2024-10-07`
- Engagement(sum): `13`
- Book signal(sum): `0`
...
## 81. 카프카를 써본적이 없는데, 요즘 제대로 처리되지 못한 사용자의 결제요청을 하나씩 복구하거나 결국 아예 복구 기능을 만들거나 하는...

- Topic: `실행력/의사결정`
- Aggregate score: `2.59`
- Tweet count: `1`
- Primary Tweet ID: `1713442957054054843`
- Date: `2023-10-15`
- Engagement(sum): `10`
- Book signal(sum): `0`
...
## 82. 요즘하는 뻘생각 한 명의 개발자가 운용 가능한 코드(피쳐)의 양이 대략 있다.

- Topic: `실행력/의사결정`
- Aggregate score: `2.59`
- Tweet count: `1`
- Primary Tweet ID: `1735103969901584650`
- Date: `2023-12-14`
- Engagement(sum): `10`
- Book signal(sum): `0`
...
## 83. chatgpt가 내 지능을 두배로 만들어서 내가 풀 수 없는 고차원의 문제를 풀게 해주는 건 아니다. 그러나 최소한 나와 비슷한...

- Topic: `팀 생산성/협업 방식`
- Aggregate score: `2.54`
- Tweet count: `1`
- Primary Tweet ID: `1731707036269002882`
- Date: `2023-12-04`
- Engagement(sum): `11`
- Book signal(sum): `0`
...
## 84. LLM쓰면서 코딩 퇴화에 대한 위기감을 가진 적은 없었는데 오늘 기획서 스샷 떤져주면서 “이 기획서를 토대로 프로토타이핑 해보고...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `2.53`
- Tweet count: `1`
- Primary Tweet ID: `1909193902244102373`
- Date: `2025-04-07`
- Engagement(sum): `13`
- Book signal(sum): `0`
...
## 85. 서드파티API가 우리쪽 서버로 리퀘스트하는 형태인데 문서가 명확치 않아 작업지연.

- Topic: `백엔드/아키텍처`
- Aggregate score: `2.45`
- Tweet count: `1`
- Primary Tweet ID: `1625859546056126468`
- Date: `2023-02-15`
- Engagement(sum): `8`
- Book signal(sum): `0`
...
## 86. 레거시에 대한 경험, 지금와 생각해보면 테스트케이스가 없거나 극단적으로 적은게 본질이었다.

- Topic: `코드 품질/리뷰`
- Aggregate score: `2.39`
- Tweet count: `1`
- Primary Tweet ID: `1653185615398334465`
- Date: `2023-05-01`
- Engagement(sum): `8`
- Book signal(sum): `0`
...
## 87. 죽음의 이지선다 A 검색해보셨나요 B 왜 안물어보셨나요 이상적인건 잠깐 구글링 해보고 안되겠다 싶으면 물어보는건데, 아차하는 순간...

- Topic: `커리어/이직 인사이트`
- Aggregate score: `2.36`
- Tweet count: `1`
- Primary Tweet ID: `1730061374372614352`
- Date: `2023-11-30`
- Engagement(sum): `9`
- Book signal(sum): `0`
...
## 88. 사용하지 않는데 폐기되지 않은 코드는 나중에 다시보면 이게 사용되지 않는다는 컨택스트를 코드읽을때 다시 파악해야 하고 이 비용은...

- Topic: `실행력/의사결정`
- Aggregate score: `2.18`
- Tweet count: `1`
- Primary Tweet ID: `1714305858908406228`
- Date: `2023-10-17`
- Engagement(sum): `10`
- Book signal(sum): `0`
...
## 89. 오늘도 Django에 붙어있던 api한개 go로 뜯어옮겼다. 직접 타이핑한 코드는 5%가 안되네.. repo크기가 작다보니 그냥...

- Topic: `백엔드/아키텍처`
- Aggregate score: `2.18`
- Tweet count: `1`
- Primary Tweet ID: `1848354372515979266`
- Date: `2024-10-21`
- Engagement(sum): `5`
- Book signal(sum): `0`
...
## 90. 요즘 느끼는 것, 대충 기능이 3가지라면 문제의 소지는 1+2+3 해서 5정도 되는 느낌 문제는 기능이 6개면 이게 순식간에 1+...

- Topic: `실행력/의사결정`
- Aggregate score: `1.98`
- Tweet count: `1`
- Primary Tweet ID: `1714312907767591403`
- Date: `2023-10-17`
- Engagement(sum): `3`
- Book signal(sum): `0`
...
## 91. 이메일 서비스 sendgrid는 일괄발송시 같은 메일 여러개 담으면 지맘대로 합쳐서 한개만 보낸다. QA분과 반나절을 토스하다 알...

- Topic: `실행력/의사결정`
- Aggregate score: `1.82`
- Tweet count: `1`
- Primary Tweet ID: `1912812416091709814`
- Date: `2025-04-17`
- Engagement(sum): `8`
- Book signal(sum): `0`
...
## 92. 40일정도 준비해온 피쳐 브랜치 머지하는날. 빅뱅 머지 시르다.. QA를 거쳤어도 불안하다. 단 1퍼센트의 오류 가능성이 있는 커...

- Topic: `실행력/의사결정`
- Aggregate score: `1.78`
- Tweet count: `1`
- Primary Tweet ID: `1844223805147041958`
- Date: `2024-10-10`
- Engagement(sum): `7`
- Book signal(sum): `0`
...
## 93. B2B도 다양, 영업주도의 비지니스, 심지어 타사 제품 리셀도 하는 회사라면 매출이 잘 나오더라도 여기에 개발자의 기여도가 거의...

- Topic: `실행력/의사결정`
- Aggregate score: `1.74`
- Tweet count: `1`
- Primary Tweet ID: `1585780451771547649`
- Date: `2022-10-27`
- Engagement(sum): `1`
- Book signal(sum): `0`
...
## 94. 사이드이팩트가 너무 싫다. 같은 파라메터로 실행하는데 결과가 다르니 토할 것 같다. 이래서 외부API랑 작업할때는 그냥 상태를 복...

- Topic: `백엔드/아키텍처`
- Aggregate score: `1.72`
- Tweet count: `1`
- Primary Tweet ID: `1717916721330483311`
- Date: `2023-10-27`
- Engagement(sum): `7`
- Book signal(sum): `0`
...
## 95. 우리팀도 이제 주니어 채용을 목전에 두고 있다보니 고민되는..

- Topic: `커리어/이직 인사이트`
- Aggregate score: `1.53`
- Tweet count: `1`
- Primary Tweet ID: `1525452933084483584`
- Date: `2022-05-14`
- Engagement(sum): `5`
- Book signal(sum): `0`
...
## 96. 결국 어낼리틱스101하는중 GA4, amplitude, mixpanel 다 붙여놓고 raw데이터 검증 위해 이벤트 따로 자체저장,...

- Topic: `실행력/의사결정`
- Aggregate score: `1.35`
- Tweet count: `1`
- Primary Tweet ID: `1575113875564863492`
- Date: `2022-09-28`
- Engagement(sum): `0`
- Book signal(sum): `0`
...
## 97. 디비레벨의 제약으로는 밸리데이션이 안되는 규칙이 계속계속 늘어가는걸 보면서 도메인모델에 대한 환상만 커지는구만.. 찍먹해볼 기회를...

- Topic: `AI 에이전트/자동화 실전`
- Aggregate score: `1.24`
- Tweet count: `1`
- Primary Tweet ID: `1717406272830775756`
- Date: `2023-10-26`
- Engagement(sum): `4`
- Book signal(sum): `0`
